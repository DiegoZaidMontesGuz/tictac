...
class RandomBoardTicTacToe:
    def __init__(self, size = (600, 800)):
        ...
        self.GRID_SIZE = 5
        self.OFFSET = 5
        self.state = [[0] * self.GRID_SIZE for _ in range(self.GRID_SIZE)]
    ...
    def draw_game(self):
        ...
        self.game = [[0]*self.GRID_SIZE] * self.GRID_SIZE
        pygame.init()
    ...
    def draw_circle(self, x, y):
        ...
        """
        pygame.draw.circle(self.screen, self.CIRCLE_COLOR, (x, y), (750 - 300 ) / self.GRID_SIZE / 2.5, 5)
        ...
        while not done:
            ...
            for event in pygame.event.get():  # User did something
                if click[0]:
                    ...
                    if not self.O_turn and self.state[s[0]][s[1]] == 0:
                        self.state[s[0]][s[1]] = 2
    ...
    def _state_to_position(self, state = [0,0] ):
        ...
        x += ((550 - 50) / self.GRID_SIZE) * (state[0] + 1) - ((750 - 300 ) / self.GRID_SIZE / 2 )
        y += (((750 - 300 ) / self.GRID_SIZE ) * (state[1] + 1)) - ((750 - 300 ) / self.GRID_SIZE / 2 )
